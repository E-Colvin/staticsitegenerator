...
class TestTextNode_to_HTMLNode(unittest.TestCase):
    ...
    def test_link(self):
        node = TextNode("This is a linked text node", TextType.LINK, "boot.dev")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "a")
        self.assertEqual(html_node.value, "This is a linked text node")
        self.assertEqual(html_node.props,{"href":"boot.dev"})

    def test_image(self):
        node = TextNode("This is a image node", TextType.IMAGE, "boot.dev")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(html_node.props,{"src":"boot.dev", "alt":"This is a image node"})
